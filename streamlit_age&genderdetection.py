# -*- coding: utf-8 -*-
"""streamlit-age&genderDetection.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1awvfD2nGacvObKK65iz83pvo8wakknax
...
image="/content/gdrive/MyDrive/Project_dl_2/project3/required files/image.jpg"
...
"""## Model used in gender prediction:-
...
### model-tried using keras but not possible as the inputs taken should be 4-D:

model1=tf.keras.Sequential()
model1.add(tf.keras.Input(shape=(227,227,3)))
model1.add(tf.keras.layers.Conv2D(96,kernel_size=(7,7),name="conv1",activation="relu",strides=(4,4)))
model1.add(tf.keras.layers.MaxPooling2D(pool_size=(3,3),name="pool1",strides=(2,2)))
model1.add(tf.keras.layers.Lambda(tf.nn.local_response_normalization(
    input,depth_radius=5,alpha=0.0001, beta=0.75, name="norm1")))

model1.add(tf.keras.layers.Conv2D(96,kernel_size=(5,5),name="conv2",padding=2,activation="relu"))
model1.add(tf.keras.layers.MaxPooling2D(pool_size=(3,3),name="pool2",strides=(2,2)))
model1.add(tf.nn.local_response_normalization(
    input,depth_radius=5, alpha=0.0001, beta=0.75, name="norm2"
))

model1.add(tf.keras.layers.Conv2D(96,kernel_size=(3,3),name="conv2",padding=1,activation="relu"))
model1.add(tf.keras.layers.MaxPooling2D(pool_size=(3,3),name="pool2",strides=(2,2)))

model1.add(tf.keras.layers.Flatten())
model1.add(tf.keras.layers.Dense(512,activation="relu",name="fc6"))
model1.add(tf.keras.layers.Dropout(0.5))
model1.add(tf.keras.layers.Dense(512,activation="relu",name="fc7"))
model1.add(tf.keras.layers.Dropout(0.5))
model1.add(tf.keras.layers.Dense(2,activation="softmax",name="fc7"))
model1.summary()
"""
